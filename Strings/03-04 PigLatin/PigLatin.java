   ...
   public static void piglatenizeFile(String fileNameIn, String fileNameOut) 
   {
      ...
      catch(IOException e)
      {
         ...
         System.exit(0);
          ...
          /*You are to process the input file into PigLatin, 
     preserving the line and paragraph structure of the input file.  
     There are several ways to preserve the line structure, but they all use nested loops. 
     You may want to consider using nextLine and split, Scanner, or StringTokenizer.*/ 
